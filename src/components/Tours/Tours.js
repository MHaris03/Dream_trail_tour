...
import Naranimg from '../../images/naran.jpg'
                ...
                <div className={classes["card"]}>
                  ...
                  <div className={classes["card__details"]}>
                    ...
                    <div className={classes["card__data"]}>
                      ...
                      <span>
                        <b>Start Date:</b> {new Date(tour.startDates).toLocaleDateString("en-US", { month: 'numeric', day: 'numeric', year: 'numeric' })}
                      </span>
                      <span>
                        <b>End Date:</b> {new Date(tour.endDates).toLocaleDateString("en-US", { month: 'numeric', day: 'numeric', year: 'numeric' })}
                      </span>
                    </div>
                    <div className={classes["card__data"]}>
                  ...
                  <div className={classes["card__footer"]}>
                    ...
                    >
                      {isTourEnded ? "Tour Ended" : "Book Now"}
                    </TourButton>
                    <Toaster />
                  </div>
                </div>
